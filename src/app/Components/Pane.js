      ...
      <Dialog>
        ...
        <div >
          {props.tasks.map((task, index) => {
            return <Card key={index} fetchTasks={props.fetchTasks} completed={task.status === 'Completed'} id={task._id} title={task.title} description={task.description} priority={task.priority} />
          })}
